import os
import pandas as pd
def explore_total_physical_attack_results(results_path: str):
...
if __name__ == "__main__":
    path = r'/tmp/pycharm_project_250/larger_images/experiments/physical_attack_untargeted_mask_equal_split_LISA_EOT-True_iter-200_level-0.43/results.csv'
    print(path)
