...
from datasets.larger_images.larger_images_settings import LARGER_IMAGES_INPUTS, LARGER_IMAGES_ANNOTATIONS, LARGER_IMAGES_MASKS
...
from settings import GENERATED_IMAGES_TYPES_TRAIN, GENERATED_IMAGES_TYPES_TEST, ATTACK_TYPE_A, ATTACK_TYPE_B, DEVICE, LISA
...
parser.add_argument("--image_path", type=str, default="ShadowAttack/tmp/gtsrb_30.png",
                    help="a file path to the target image should be specified for a physical attack")
parser.add_argument("--mask_path", type=str, default="ShadowAttack/tmp/gtsrb_30_mask.png",
...
def attack(attack_image, label, coords, targeted_attack=False, physical_attack=False, **parameters):
    ...
    for attempt in range(n_try):
        ...
        pso = PSO(polygon * 2, particle_size, iter_num, x_min, x_max, max_speed, shadow_level, attack_image, coords,
                  model, targeted_attack, physical_attack, label, pre_process, **parameters)
