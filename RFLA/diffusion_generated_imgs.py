...
from utils.img_utils import crop_image
...
class DiffusionImages:
    def __init__(self, img_name, img_bbx, size, experiment_dir):
        ...
        self.output_dir_normal = os.path.join(self.output_dir, 'normal_attack')
        self.output_dir_special = os.path.join(self.output_dir, 'special_attack')  # with diffusion
