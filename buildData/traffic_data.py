...
class TrafficData:
    def __init__(self, attack_db: str, parent_dir: str = 'larger_images', image_inputs_dir: str = 'image_inputs',
                 ...
                 mask_dir: str = None, crop_size: int = 224):
        ...
        self.file_names, self.orig_imgs, self.cropped_imgs, self.cropped_resized_imgs, \
            ...
            self.attack_db, crop_size=crop_size, mask_folder=self.mask_dir)  # /workspace/traffic-diffusion/


    def set_dirs(self, image_annotations_dir: str, image_inputs_dir: str, mask_dir: str, parent_dir: str):
        if parent_dir:
